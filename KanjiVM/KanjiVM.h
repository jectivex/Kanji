...
//
////! Project version number for KanjiVM.
//FOUNDATION_EXPORT double KanjiVMVersionNumber;
//
////! Project version string for KanjiVM.
//FOUNDATION_EXPORT const unsigned char KanjiVMVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <KanjiVM/PublicHeader.h>
...
// The above delcarations code won't work in Swift because it doesn't support C++ or invoking opaque C function pointers, so we need to create our own JNI cover functions


jint JavaVM_DestroyJavaVM(JavaVM *jvm) {
    return (*jvm)->DestroyJavaVM(jvm);
}
jint JavaVM_AttachCurrentThread(JavaVM *jvm, void **penv, void *args) {
    return (*jvm)->AttachCurrentThread(jvm, penv, args);
}
jint JavaVM_DetachCurrentThread(JavaVM *jvm) {
    return (*jvm)->DetachCurrentThread(jvm);
}

jint JavaVM_GetEnv(JavaVM *jvm, void **penv, jint version) {
    return (*jvm)->GetEnv(jvm, penv, version);
}
jint JavaVM_AttachCurrentThreadAsDaemon(JavaVM *jvm, void **penv, void *args) {
    return (*jvm)->AttachCurrentThreadAsDaemon(jvm, penv, args);
}
...
jclass JNI_DefineClass(JNIEnv *env, const char *name, jobject loader, const jbyte *buf,
                   jsize len) {
...
jobject JNI_NewObjectV(JNIEnv *env, jclass clazz, jmethodID methodID,
                   va_list args) {
    return (*env)->NewObjectV(env,clazz,methodID,args);
}
jobject JNI_NewObjectA(JNIEnv *env, jclass clazz, jmethodID methodID,
                   const jvalue *args) {
...
jobject JNI_CallObjectMethodV(JNIEnv *env, jobject obj, jmethodID methodID,
                          va_list args) {
    return (*env)->CallObjectMethodV(env,obj,methodID,args);
}
jobject JNI_CallObjectMethodA(JNIEnv *env, jobject obj, jmethodID methodID,
                          const jvalue * args) {
    return (*env)->CallObjectMethodA(env,obj,methodID,args);
}

jboolean JNI_CallBooleanMethod(JNIEnv *env, jobject obj,
                           jmethodID methodID, ...) {
    va_list args;
    jboolean result;
    va_start(args,methodID);
...
jboolean JNI_CallBooleanMethodV(JNIEnv *env, jobject obj, jmethodID methodID,
                            va_list args) {
    return (*env)->CallBooleanMethodV(env,obj,methodID,args);
}
jboolean JNI_CallBooleanMethodA(JNIEnv *env, jobject obj, jmethodID methodID,
                            const jvalue * args) {
...
jbyte JNI_CallByteMethodV(JNIEnv *env, jobject obj, jmethodID methodID,
                      va_list args) {
    return (*env)->CallByteMethodV(env,obj,methodID,args);
}
jbyte JNI_CallByteMethodA(JNIEnv *env, jobject obj, jmethodID methodID,
                      const jvalue * args) {
...
jchar JNI_CallCharMethodV(JNIEnv *env, jobject obj, jmethodID methodID,
                      va_list args) {
    return (*env)->CallCharMethodV(env,obj,methodID,args);
}
jchar JNI_CallCharMethodA(JNIEnv *env, jobject obj, jmethodID methodID,
                      const jvalue * args) {
...
jshort JNI_CallShortMethodV(JNIEnv *env, jobject obj, jmethodID methodID,
                        va_list args) {
    return (*env)->CallShortMethodV(env,obj,methodID,args);
}
jshort JNI_CallShortMethodA(JNIEnv *env, jobject obj, jmethodID methodID,
                        const jvalue * args) {
...
jint JNI_CallIntMethodV(JNIEnv *env, jobject obj, jmethodID methodID,
                    va_list args) {
    return (*env)->CallIntMethodV(env,obj,methodID,args);
}
jint JNI_CallIntMethodA(JNIEnv *env, jobject obj, jmethodID methodID,
                    const jvalue * args) {
...
jlong JNI_CallLongMethodV(JNIEnv *env, jobject obj, jmethodID methodID,
                      va_list args) {
    return (*env)->CallLongMethodV(env,obj,methodID,args);
}
jlong JNI_CallLongMethodA(JNIEnv *env, jobject obj, jmethodID methodID,
                      const jvalue * args) {
...
jfloat JNI_CallFloatMethodV(JNIEnv *env, jobject obj, jmethodID methodID,
                        va_list args) {
    return (*env)->CallFloatMethodV(env,obj,methodID,args);
}
jfloat JNI_CallFloatMethodA(JNIEnv *env, jobject obj, jmethodID methodID,
                        const jvalue * args) {
...
jdouble JNI_CallDoubleMethodV(JNIEnv *env, jobject obj, jmethodID methodID,
                          va_list args) {
    return (*env)->CallDoubleMethodV(env,obj,methodID,args);
}
jdouble JNI_CallDoubleMethodA(JNIEnv *env, jobject obj, jmethodID methodID,
                          const jvalue * args) {
...
void JNI_CallVoidMethodV(JNIEnv *env, jobject obj, jmethodID methodID,
                     va_list args) {
    (*env)->CallVoidMethodV(env,obj,methodID,args);
}
void JNI_CallVoidMethodA(JNIEnv *env, jobject obj, jmethodID methodID,
                     const jvalue * args) {
...
jboolean JNI_CallNonvirtualBooleanMethodV(JNIEnv *env, jobject obj, jclass clazz,
                                      jmethodID methodID, va_list args) {
    return (*env)->CallNonvirtualBooleanMethodV(env,obj,clazz,
                                                   methodID,args);
}
jboolean JNI_CallNonvirtualBooleanMethodA(JNIEnv *env, jobject obj, jclass clazz,
                                      jmethodID methodID, const jvalue * args) {
...
jfieldID JNI_GetFieldID(JNIEnv *env, jclass clazz, const char *name,
                    const char *sig) {
...
void JNI_SetBooleanField(JNIEnv *env, jobject obj, jfieldID fieldID,
                     jboolean val) {
    (*env)->SetBooleanField(env,obj,fieldID,val);
}
void JNI_SetByteField(JNIEnv *env, jobject obj, jfieldID fieldID,
                  jbyte val) {
    (*env)->SetByteField(env,obj,fieldID,val);
}
void JNI_SetCharField(JNIEnv *env, jobject obj, jfieldID fieldID,
                  jchar val) {
    (*env)->SetCharField(env,obj,fieldID,val);
}
void JNI_SetShortField(JNIEnv *env, jobject obj, jfieldID fieldID,
                   jshort val) {
    (*env)->SetShortField(env,obj,fieldID,val);
}
void JNI_SetIntField(JNIEnv *env, jobject obj, jfieldID fieldID,
                 jint val) {
    (*env)->SetIntField(env,obj,fieldID,val);
}
void JNI_SetLongField(JNIEnv *env, jobject obj, jfieldID fieldID,
                  jlong val) {
    (*env)->SetLongField(env,obj,fieldID,val);
}
void JNI_SetFloatField(JNIEnv *env, jobject obj, jfieldID fieldID,
                   jfloat val) {
    (*env)->SetFloatField(env,obj,fieldID,val);
}
void JNI_SetDoubleField(JNIEnv *env, jobject obj, jfieldID fieldID,
                    jdouble val) {
...
jobject JNI_CallStaticObjectMethodV(JNIEnv *env, jclass clazz, jmethodID methodID,
                                va_list args) {
    return (*env)->CallStaticObjectMethodV(env,clazz,methodID,args);
}
jobject JNI_CallStaticObjectMethodA(JNIEnv *env, jclass clazz, jmethodID methodID,
                                const jvalue *args) {
    return (*env)->CallStaticObjectMethodA(env,clazz,methodID,args);
}

jboolean JNI_CallStaticBooleanMethod(JNIEnv *env, jclass clazz,
                                 jmethodID methodID, ...) {
    va_list args;
    jboolean result;
    va_start(args,methodID);
...
jboolean JNI_CallStaticBooleanMethodV(JNIEnv *env, jclass clazz,
                                  jmethodID methodID, va_list args) {
    return (*env)->CallStaticBooleanMethodV(env,clazz,methodID,args);
}
jboolean JNI_CallStaticBooleanMethodA(JNIEnv *env, jclass clazz,
                                  jmethodID methodID, const jvalue *args) {
    return (*env)->CallStaticBooleanMethodA(env,clazz,methodID,args);
}

jbyte JNI_CallStaticByteMethod(JNIEnv *env, jclass clazz,
                           jmethodID methodID, ...) {
    va_list args;
    jbyte result;
    va_start(args,methodID);
...
jbyte JNI_CallStaticByteMethodV(JNIEnv *env, jclass clazz,
                            jmethodID methodID, va_list args) {
    return (*env)->CallStaticByteMethodV(env,clazz,methodID,args);
}
jbyte JNI_CallStaticByteMethodA(JNIEnv *env, jclass clazz,
                            jmethodID methodID, const jvalue *args) {
    return (*env)->CallStaticByteMethodA(env,clazz,methodID,args);
}

jchar JNI_CallStaticCharMethod(JNIEnv *env, jclass clazz,
                           jmethodID methodID, ...) {
    va_list args;
    jchar result;
    va_start(args,methodID);
...
jchar JNI_CallStaticCharMethodV(JNIEnv *env, jclass clazz,
                            jmethodID methodID, va_list args) {
    return (*env)->CallStaticCharMethodV(env,clazz,methodID,args);
}
jchar JNI_CallStaticCharMethodA(JNIEnv *env, jclass clazz,
                            jmethodID methodID, const jvalue *args) {
    return (*env)->CallStaticCharMethodA(env,clazz,methodID,args);
}

jshort JNI_CallStaticShortMethod(JNIEnv *env, jclass clazz,
                             jmethodID methodID, ...) {
    va_list args;
    jshort result;
    va_start(args,methodID);
...
jshort JNI_CallStaticShortMethodV(JNIEnv *env, jclass clazz,
                              jmethodID methodID, va_list args) {
    return (*env)->CallStaticShortMethodV(env,clazz,methodID,args);
}
jshort JNI_CallStaticShortMethodA(JNIEnv *env, jclass clazz,
                              jmethodID methodID, const jvalue *args) {
    return (*env)->CallStaticShortMethodA(env,clazz,methodID,args);
}

jint JNI_CallStaticIntMethod(JNIEnv *env, jclass clazz,
                         jmethodID methodID, ...) {
    va_list args;
    jint result;
    va_start(args,methodID);
...
jint JNI_CallStaticIntMethodV(JNIEnv *env, jclass clazz,
                          jmethodID methodID, va_list args) {
    return (*env)->CallStaticIntMethodV(env,clazz,methodID,args);
}
jint JNI_CallStaticIntMethodA(JNIEnv *env, jclass clazz,
                          jmethodID methodID, const jvalue *args) {
    return (*env)->CallStaticIntMethodA(env,clazz,methodID,args);
}

jlong JNI_CallStaticLongMethod(JNIEnv *env, jclass clazz,
                           jmethodID methodID, ...) {
    va_list args;
    jlong result;
    va_start(args,methodID);
...
jlong JNI_CallStaticLongMethodV(JNIEnv *env, jclass clazz,
                            jmethodID methodID, va_list args) {
    return (*env)->CallStaticLongMethodV(env,clazz,methodID,args);
}
jlong JNI_CallStaticLongMethodA(JNIEnv *env, jclass clazz,
                            jmethodID methodID, const jvalue *args) {
    return (*env)->CallStaticLongMethodA(env,clazz,methodID,args);
}

jfloat JNI_CallStaticFloatMethod(JNIEnv *env, jclass clazz,
                             jmethodID methodID, ...) {
    va_list args;
    jfloat result;
    va_start(args,methodID);
...
jfloat JNI_CallStaticFloatMethodV(JNIEnv *env, jclass clazz,
                              jmethodID methodID, va_list args) {
    return (*env)->CallStaticFloatMethodV(env,clazz,methodID,args);
}
jfloat JNI_CallStaticFloatMethodA(JNIEnv *env, jclass clazz,
                              jmethodID methodID, const jvalue *args) {
    return (*env)->CallStaticFloatMethodA(env,clazz,methodID,args);
}

jdouble JNI_CallStaticDoubleMethod(JNIEnv *env, jclass clazz,
                               jmethodID methodID, ...) {
    va_list args;
    jdouble result;
    va_start(args,methodID);
...
jdouble JNI_CallStaticDoubleMethodV(JNIEnv *env, jclass clazz,
                                jmethodID methodID, va_list args) {
    return (*env)->CallStaticDoubleMethodV(env,clazz,methodID,args);
}
jdouble JNI_CallStaticDoubleMethodA(JNIEnv *env, jclass clazz,
                                jmethodID methodID, const jvalue *args) {
...
void JNI_CallStaticVoidMethodV(JNIEnv *env, jclass cls, jmethodID methodID,
                           va_list args) {
    (*env)->CallStaticVoidMethodV(env,cls,methodID,args);
}
void JNI_CallStaticVoidMethodA(JNIEnv *env, jclass cls, jmethodID methodID,
                           const jvalue * args) {
...
void JNI_SetStaticObjectField(JNIEnv *env, jclass clazz, jfieldID fieldID,
                          jobject value) {
    (*env)->SetStaticObjectField(env,clazz,fieldID,value);
}
void JNI_SetStaticBooleanField(JNIEnv *env, jclass clazz, jfieldID fieldID,
                           jboolean value) {
    (*env)->SetStaticBooleanField(env,clazz,fieldID,value);
}
void JNI_SetStaticByteField(JNIEnv *env, jclass clazz, jfieldID fieldID,
                        jbyte value) {
    (*env)->SetStaticByteField(env,clazz,fieldID,value);
}
void JNI_SetStaticCharField(JNIEnv *env, jclass clazz, jfieldID fieldID,
                        jchar value) {
    (*env)->SetStaticCharField(env,clazz,fieldID,value);
}
void JNI_SetStaticShortField(JNIEnv *env, jclass clazz, jfieldID fieldID,
                         jshort value) {
    (*env)->SetStaticShortField(env,clazz,fieldID,value);
}
void JNI_SetStaticIntField(JNIEnv *env, jclass clazz, jfieldID fieldID,
                       jint value) {
    (*env)->SetStaticIntField(env,clazz,fieldID,value);
}
void JNI_SetStaticLongField(JNIEnv *env, jclass clazz, jfieldID fieldID,
                        jlong value) {
    (*env)->SetStaticLongField(env,clazz,fieldID,value);
}
void JNI_SetStaticFloatField(JNIEnv *env, jclass clazz, jfieldID fieldID,
                         jfloat value) {
    (*env)->SetStaticFloatField(env,clazz,fieldID,value);
}
void JNI_SetStaticDoubleField(JNIEnv *env, jclass clazz, jfieldID fieldID,
                          jdouble value) {
...
void JNI_SetObjectArrayElement(JNIEnv *env, jobjectArray array, jsize index,
                           jobject val) {
...
void JNI_ReleaseBooleanArrayElements(JNIEnv *env, jbooleanArray array,
                                 jboolean *elems,
                                 jint mode) {
    (*env)->ReleaseBooleanArrayElements(env,array,elems,mode);
}
void JNI_ReleaseByteArrayElements(JNIEnv *env, jbyteArray array,
                              jbyte *elems,
                              jint mode) {
    (*env)->ReleaseByteArrayElements(env,array,elems,mode);
}
void JNI_ReleaseCharArrayElements(JNIEnv *env, jcharArray array,
                              jchar *elems,
                              jint mode) {
    (*env)->ReleaseCharArrayElements(env,array,elems,mode);
}
void JNI_ReleaseShortArrayElements(JNIEnv *env, jshortArray array,
                               jshort *elems,
                               jint mode) {
    (*env)->ReleaseShortArrayElements(env,array,elems,mode);
}
void JNI_ReleaseIntArrayElements(JNIEnv *env, jintArray array,
                             jint *elems,
                             jint mode) {
    (*env)->ReleaseIntArrayElements(env,array,elems,mode);
}
void JNI_ReleaseLongArrayElements(JNIEnv *env, jlongArray array,
                              jlong *elems,
                              jint mode) {
    (*env)->ReleaseLongArrayElements(env,array,elems,mode);
}
void JNI_ReleaseFloatArrayElements(JNIEnv *env, jfloatArray array,
                               jfloat *elems,
                               jint mode) {
    (*env)->ReleaseFloatArrayElements(env,array,elems,mode);
}
void JNI_ReleaseDoubleArrayElements(JNIEnv *env, jdoubleArray array,
                                jdouble *elems,
                                jint mode) {
    (*env)->ReleaseDoubleArrayElements(env,array,elems,mode);
}

void JNI_GetBooleanArrayRegion(JNIEnv *env, jbooleanArray array,
                           jsize start, jsize len, jboolean *buf) {
    (*env)->GetBooleanArrayRegion(env,array,start,len,buf);
}
void JNI_GetByteArrayRegion(JNIEnv *env, jbyteArray array,
                        jsize start, jsize len, jbyte *buf) {
    (*env)->GetByteArrayRegion(env,array,start,len,buf);
}
void JNI_GetCharArrayRegion(JNIEnv *env, jcharArray array,
                        jsize start, jsize len, jchar *buf) {
    (*env)->GetCharArrayRegion(env,array,start,len,buf);
}
void JNI_GetShortArrayRegion(JNIEnv *env, jshortArray array,
                         jsize start, jsize len, jshort *buf) {
    (*env)->GetShortArrayRegion(env,array,start,len,buf);
}
void JNI_GetIntArrayRegion(JNIEnv *env, jintArray array,
                       jsize start, jsize len, jint *buf) {
    (*env)->GetIntArrayRegion(env,array,start,len,buf);
}
void JNI_GetLongArrayRegion(JNIEnv *env, jlongArray array,
                        jsize start, jsize len, jlong *buf) {
    (*env)->GetLongArrayRegion(env,array,start,len,buf);
}
void JNI_GetFloatArrayRegion(JNIEnv *env, jfloatArray array,
                         jsize start, jsize len, jfloat *buf) {
    (*env)->GetFloatArrayRegion(env,array,start,len,buf);
}
void JNI_GetDoubleArrayRegion(JNIEnv *env, jdoubleArray array,
                          jsize start, jsize len, jdouble *buf) {
    (*env)->GetDoubleArrayRegion(env,array,start,len,buf);
}

void JNI_SetBooleanArrayRegion(JNIEnv *env, jbooleanArray array, jsize start, jsize len,
                           const jboolean *buf) {
    (*env)->SetBooleanArrayRegion(env,array,start,len,buf);
}
void JNI_SetByteArrayRegion(JNIEnv *env, jbyteArray array, jsize start, jsize len,
                        const jbyte *buf) {
    (*env)->SetByteArrayRegion(env,array,start,len,buf);
}
void JNI_SetCharArrayRegion(JNIEnv *env, jcharArray array, jsize start, jsize len,
                        const jchar *buf) {
    (*env)->SetCharArrayRegion(env,array,start,len,buf);
}
void JNI_SetShortArrayRegion(JNIEnv *env, jshortArray array, jsize start, jsize len,
                         const jshort *buf) {
    (*env)->SetShortArrayRegion(env,array,start,len,buf);
}
void JNI_SetIntArrayRegion(JNIEnv *env, jintArray array, jsize start, jsize len,
                       const jint *buf) {
    (*env)->SetIntArrayRegion(env,array,start,len,buf);
}
void JNI_SetLongArrayRegion(JNIEnv *env, jlongArray array, jsize start, jsize len,
                        const jlong *buf) {
    (*env)->SetLongArrayRegion(env,array,start,len,buf);
}
void JNI_SetFloatArrayRegion(JNIEnv *env, jfloatArray array, jsize start, jsize len,
                         const jfloat *buf) {
    (*env)->SetFloatArrayRegion(env,array,start,len,buf);
}
void JNI_SetDoubleArrayRegion(JNIEnv *env, jdoubleArray array, jsize start, jsize len,
                          const jdouble *buf) {
    (*env)->SetDoubleArrayRegion(env,array,start,len,buf);
}

jint JNI_RegisterNatives(JNIEnv *env, jclass clazz, const JNINativeMethod *methods,
                     jint nMethods) {
