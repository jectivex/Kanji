...
open class javax$security$auth$Destroyable$Impl : java$lang$Object, javax$security$auth$Destroyable {
    private typealias J = javax$security$auth$Destroyable$Impl
    private typealias I = J
