...
open class java$awt$Image$Impl : java$lang$Object, java$awt$Image {
    private typealias J = java$awt$Image$Impl
    private typealias I = J

    /// Returns the internal JNI name for this class: "java/awt/Image"
    open class override func jniName() -> String { return "java/awt/Image" }

}

public protocol java$awt$Graphics : JavaObject {
}

open class java$awt$Graphics$Impl : java$lang$Object, java$awt$Graphics {
    private typealias J = java$awt$Graphics$Impl
    private typealias I = J

    /// Returns the internal JNI name for this class: "java/awt/Graphics"
    open class override func jniName() -> String { return "java/awt/Graphics" }
...
open class java$awt$Rectangle$Impl : java$lang$Object, java$awt$Rectangle {
    private typealias J = java$awt$Rectangle$Impl
    private typealias I = J
