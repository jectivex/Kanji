...
public extension JVM {
    ...
    public func createNativeAddressableClass<F: JavaObject>(_ name: String? = nil, extends: String = "java/lang/Object", interfaces: [String] = [], methods: [MethodSignature], finalizer: @escaping @convention(c) (UnsafePointer<JNIEnv>, jclass, jlong) -> ()) throws -> (cls: jclass, constructor: (jlong) throws -> F) {
        var methods = methods
...
public extension java$lang$Runnable$Impl {
    ...
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject) -> ()) throws -> java$lang$Runnable {
...
public extension java$util$concurrent$Callable$Impl {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject) -> jobject) throws -> java$util$concurrent$Callable {
...
public extension java$util$Comparator$Impl {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject, jobject) -> jint) throws -> java$util$Comparator {
...
//    public typealias Slf = Self
    ...
    fileprivate static func functionalMethod(_ f: @escaping FunctionalBlock) -> JVM.MethodSignature {
        return ("apply", FunctionalSig, unsafeBitCast(f, to: UnsafeMutableRawPointer.self))
    }
    
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping FunctionalBlock) throws -> Slf {
...
public extension java$util$function$Consumer {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject) -> Void) throws -> Self {
...
public extension java$util$function$IntFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jint) -> jobject) throws -> Self {
...
public extension java$util$function$IntBinaryOperator {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jint, jint) -> jint) throws -> Self {
...
public extension java$util$function$IntConsumer {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jint) -> Void) throws -> Self {
...
public extension java$util$function$IntPredicate {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jint) -> jboolean) throws -> Self {
...
public extension java$util$function$IntSupplier {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject) -> jint) throws -> Self {
...
public extension java$util$function$IntToDoubleFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jint) -> jdouble) throws -> Self {
...
public extension java$util$function$IntToLongFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jint) -> jlong) throws -> Self {
...
public extension java$util$function$IntUnaryOperator {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jint) -> jint) throws -> Self {
...
public extension java$util$function$ToIntFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject) -> jint) throws -> Self {
...
public extension java$util$function$ToIntBiFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject, jobject) -> jint) throws -> Self {
...
public extension java$util$function$LongFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jlong) -> jobject) throws -> Self {
...
public extension java$util$function$LongBinaryOperator {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jlong, jlong) -> jlong) throws -> Self {
...
public extension java$util$function$LongConsumer {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jlong) -> Void) throws -> Self {
...
public extension java$util$function$LongPredicate {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jlong) -> jboolean) throws -> Self {
...
public extension java$util$function$LongSupplier {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject) -> jlong) throws -> Self {
...
public extension java$util$function$LongToDoubleFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jlong) -> jdouble) throws -> Self {
...
public extension java$util$function$LongToIntFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jlong) -> jint) throws -> Self {
...
public extension java$util$function$LongUnaryOperator {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jlong) -> jlong) throws -> Self {
...
public extension java$util$function$ToLongFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject) -> jlong) throws -> Self {
...
public extension java$util$function$ToLongBiFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject, jobject) -> jlong) throws -> Self {
...
public extension java$util$function$DoubleFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jdouble) -> jobject) throws -> Self {
...
public extension java$util$function$DoubleBinaryOperator {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jdouble, jdouble) -> jdouble) throws -> Self {
...
public extension java$util$function$DoubleConsumer {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jdouble) -> Void) throws -> Self {
...
public extension java$util$function$DoublePredicate {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jdouble) -> jboolean) throws -> Self {
...
public extension java$util$function$DoubleSupplier {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject) -> jdouble) throws -> Self {
...
public extension java$util$function$DoubleToLongFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jdouble) -> jlong) throws -> Self {
...
public extension java$util$function$DoubleToIntFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jdouble) -> jint) throws -> Self {
...
public extension java$util$function$DoubleUnaryOperator {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jdouble) -> jdouble) throws -> Self {
...
public extension java$util$function$ToDoubleFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject) -> jdouble) throws -> Self {
...
public extension java$util$function$ToDoubleBiFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject, jobject) -> jdouble) throws -> Self {
...
public extension java$util$function$BooleanSupplier {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject) -> jboolean) throws -> Self {
...
public extension java$util$function$Supplier {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject) -> jobject) throws -> Self {
        let sig = JVM.jsig(JObjectType(), args: [])
        return try JVM.sharedJVM.createNativeClass(interfaces: [self.jniName()], methods: [
...
public extension java$util$function$Predicate {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject) -> jboolean) throws -> Self {
...
public extension java$util$function$BiPredicate {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject, jobject) -> jboolean) throws -> Self {
...
public extension java$util$function$BiConsumer {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject, jobject) -> Void) throws -> Self {
...
public extension java$util$function$BiFunction {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject, jobject) -> jobject) throws -> Self {
...
public extension java$util$function$ObjLongConsumer {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject, jlong) -> Void) throws -> Self {
...
public extension java$util$function$ObjDoubleConsumer {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject, jdouble) -> Void) throws -> Self {
...
public extension java$util$function$ObjIntConsumer {
    /// Returns an instance of this type where the FunctionalInterface is implemented by a non-capturing C block
    public static func fromBlock(_ native: @escaping @convention(c) (UnsafePointer<JNIEnv>, jobject, jobject, jint) -> Void) throws -> Self {
